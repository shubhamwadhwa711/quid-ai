...
const Brands = () => {
  ...
  return (
    <div className="relative border h-52 rounded-xl p-">
      {/* Title */}
      <h1 className="absolute proxima -top-5 left-1/2 -translate-x-1/2 text-nowrap px-4 py-1 bg-white/1 backdrop-blur-sm text-white z-10 rounded-md">
      ...
      <div className="m-4 pb-2 flex gap-4 overflow-x-auto hide-scrollbar">
        {companyCategory.map((category) => (
          <Button
            ...
            className={`px-6 py-2 w-auto h-4 proxima-category rounded-full text-sm  transition-all backdrop-blur-md ${
